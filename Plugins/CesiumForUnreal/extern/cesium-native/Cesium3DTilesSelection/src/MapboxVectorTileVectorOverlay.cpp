...
class MapboxVectorTileProvider final
...
public:
  ...
  virtual ~MapboxVectorTileProvider() {}
...
MapboxVectorTileVectorOverlay::MapboxVectorTileVectorOverlay(
    const std::string& name,
    const std::string& url,
    const std::vector<IAssetAccessor::THeader>& headers,
    const MapboxVectorTileVectorOverlayOptions& tmsOptions,
...
MapboxVectorTileVectorOverlay::createTileProvider(
    const CesiumAsync::AsyncSystem& asyncSystem,
  ...
  return getXmlDocument(asyncSystem, pAssetAccessor, xmlUrl, this->_headers)
      .thenInMainThread(
              ...
              GetXmlDocumentResult&& xml) -> CreateTileProviderResult
        {
            ...
            return new MapboxVectorTileProvider(
                pOwner,
                asyncSystem,
                pAssetAccessor,
                credit,
