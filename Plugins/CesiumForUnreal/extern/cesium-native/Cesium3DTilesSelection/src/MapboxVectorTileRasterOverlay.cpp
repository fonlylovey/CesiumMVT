#include "Cesium3DTilesSelection/MapboxVectorTileRasterOverlay.h"
...
MapboxVectorTileRasterOverlay::MapboxVectorTileRasterOverlay(
    const std::string& name,
    const std::string& url,
    const std::vector<IAssetAccessor::THeader>& headers,
    const MapboxVectorTileRasterOverlayOptions& tmsOptions,
...
MapboxVectorTileRasterOverlay::createTileProvider(
    const CesiumAsync::AsyncSystem& asyncSystem,
