...
struct TiandiTuRasterOverlayOptions {
  ...
  /**
   * @brief The style of Tianditu RasterOverlay.
   */
  std::optional<std::string> MapStyle;

  /**
   * @brief The Token of Tianditu RasterOverlay.
   * value:
   *
   */
 ...
 */
class CESIUM3DTILESSELECTION_API TiandiTuRasterOverlay final
...
public:
   ...
   * @param xyzOptions The {@link XYZRasterOverlayOptions}.
