 ...
 */
struct WebMapTileServiceVectorOverlayOptions {
 ...
 */
class CESIUM3DTILESSELECTION_API WebMapTileServiceVectorOverlay final
...
private:
  ...
  WebMapTileServiceVectorOverlayOptions _options;
};
