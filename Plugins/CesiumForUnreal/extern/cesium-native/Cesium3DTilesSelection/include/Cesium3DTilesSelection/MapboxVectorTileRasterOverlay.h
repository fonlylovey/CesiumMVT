 ...
 * @brief 
 */
struct MapboxVectorTileRasterOverlayOptions {
 ...
 */
class CESIUM3DTILESSELECTION_API MapboxVectorTileRasterOverlay final
...
public:
  ...
  virtual ~MapboxVectorTileRasterOverlay() override;
...
private:
  ...
  MapboxVectorTileRasterOverlayOptions _options;
};
