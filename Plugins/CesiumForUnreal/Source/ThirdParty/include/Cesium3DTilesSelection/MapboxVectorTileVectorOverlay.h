 ...
 * @brief 
 */
struct MapboxVectorTileVectorOverlayOptions {
 ...
 */
class CESIUM3DTILESSELECTION_API MapboxVectorTileVectorOverlay final
...
public:
  ...
  virtual ~MapboxVectorTileVectorOverlay() override;
...
private:
  ...
  MapboxVectorTileVectorOverlayOptions _options;
};
