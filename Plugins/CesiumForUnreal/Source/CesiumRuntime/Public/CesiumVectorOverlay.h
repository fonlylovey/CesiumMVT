...
#include "CesiumVectorOverlayLoadFailureDetails.h"
#include "Components/ActorComponent.h"
#include "CoreMinimal.h"
#include "Engine/Texture.h"
#include "Engine/TextureDefines.h"
#include <memory>
#include "CesiumVectorOverlay.generated.h"
...
protected:
  ...
  virtual std::unique_ptr<Cesium3DTilesSelection::VectorOverlay> CreateOverlay(
      ...
      PURE_VIRTUAL(UCesiumVectorOverlay::CreateOverlay, return nullptr;);

  virtual void OnAdd(
      Cesium3DTilesSelection::Tileset* pTileset,
      Cesium3DTilesSelection::VectorOverlay * pOverlay) {}
  virtual void OnRemove(
      Cesium3DTilesSelection::Tileset* pTileset,
      Cesium3DTilesSelection::VectorOverlay* pOverlay) {}

private:
  Cesium3DTilesSelection::VectorOverlay* _pOverlay;
